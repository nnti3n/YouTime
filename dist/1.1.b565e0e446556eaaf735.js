...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.actions = exports.SEARCH_VIDEO = undefined;
	...
	// Constants
	// ------------------------------------
	var SEARCH_VIDEO = exports.SEARCH_VIDEO = 'SEARCH VIDEO';
	...
	// Action Handlers
	// ------------------------------------
	var LIST_ACTION_HANDLERS = (0, _defineProperty3.default)({}, SEARCH_VIDEO, function (state, action) {
	  return (0, _extends3.default)({}, state, { video_url: action.payload });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentList = __webpack_require__(393);
	
	var _CommentList2 = _interopRequireDefault(_CommentList);
	
	var _VideoPlayer = __webpack_require__(395);
	
	var _VideoPlayer2 = _interopRequireDefault(_VideoPlayer);
	
	var _CommentBar = __webpack_require__(404);
	
	var _CommentBar2 = _interopRequireDefault(_CommentBar);
	
	var _SuggestVideo = __webpack_require__(405);
	
	var _SuggestVideo2 = _interopRequireDefault(_SuggestVideo);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var YOUTIME_API = 'http://youtime.herokuapp.com';
	...
	var HomeView = function (_React$Component) {
	  ...
	  function HomeView(props) {
	    ...
	    _this.updateComment = function (currentTime) {
	      currentTime *= 1000;
	      _this.setState({
	        currentTime: currentTime,
	        currentComment: _this.state.commentList.filter(function (data) {
	          return data.time <= currentTime && data.time + 5000 >= currentTime;
	        })
	      });
	    };
	
	    _this.postComment = function (commentObject, callback) {
	      var option = {
	        method: 'POST',
	        body: (0, _stringify2.default)(commentObject),
	        mode: 'cors',
	        headers: new Headers({ "Content-Type": "application/json" })
	      };
	      fetch(YOUTIME_API + "/video/" + _this.state.videoRemoteId, option).then(function (res) {
	        if (res.ok) {
	    ...
	    _this.fetchSuggestedVideo = function (limit) {
	      fetch(YOUTIME_API + ('/video/random?limit=' + limit)).then(function (res) {
	        return res.json();
	      }).then(function (data) {
	        _this.setState({
	          suggestVideo: data
	    ...
	    _this.SearchVideo = function (link) {
	      if (link.indexOf('youtube') !== -1 || link.indexOf('youtu.be') !== -1) {
	        ...
	        _this.fetchVideoComment(videoId);
	        _this.fetchSuggestedVideo(4);
	      } else {
	    ...
	    _this.commentClickHandler = function (comment) {
	      _this.setState({
	    ...
	    _this.videoClickHandler = function (video) {
	      console.log(video);
	      _this.setState({
	        videoId: video.url.id
	      });
	      _this.fetchVideoComment(video.url.id);
	    };
	
	    _this.changeJustSeek = function (justSeek) {
	      _this.setState({ justSeek: justSeek });
	    };
	    ...
	    _this.commentClickHandler = _this.commentClickHandler.bind(_this);
	    _this.updateComment = _this.updateComment.bind(_this);
	    _this.postComment = _this.postComment.bind(_this);
	    _this.fetchVideoComment = _this.fetchVideoComment.bind(_this);
	    _this.SearchVideo = _this.SearchVideo.bind(_this);
	    return _this;
	  }
	
	  (0, _createClass3.default)(HomeView, [{
	    key: 'fetchVideoComment',
	    value: function fetchVideoComment(videoId) {
	      var _this2 = this;
	
	      fetch(YOUTIME_API + ('/video/link?site=youtube&id=' + videoId)).then(function (res) {
	        return res.json();
	      }).then(function (data) {
	        _this2.setState({
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'Menu u-margin-bottom--40' },
	          _react2.default.createElement(
	            'h2',
	            { className: 'Menu-title' },
	            'YouTime'
	          ),
	          _react2.default.createElement(_SearchBar2.default, { SearchVideo: this.SearchVideo })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'ViewBox u-margin-bottom--24' },
	          _react2.default.createElement(
	            'div',
	            null,
	            ...
	            _react2.default.createElement(_CommentBar2.default, {
	              currentComment: this.state.currentComment,
	              currentTime: this.state.currentTime,
	              postComment: this.postComment
	            })
	          ),
	          _react2.default.createElement(_CommentList2.default, { commentList: this.state.commentList, commentClickHandler: this.commentClickHandler })
	        ),
	        _react2.default.createElement(
	          'h4',
	        ...
	        _react2.default.createElement(_SuggestVideo2.default, { videoList: this.state.suggestVideo, videoClickHandler: this.videoClickHandler })
	      );
	    }
	  }]);
	  return HomeView;
	...
	HomeView.propTypes = {
	  SearchVideo: _react2.default.PropTypes.func
	};
	...
	var SearchBar = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(SearchBar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'SearchBar Menu-item input-group stylish-input-group' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Helper = __webpack_require__(394);
	  ...
	  (0, _createClass3.default)(CommentList, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          commentList = _props.commentList,
	          commentClickHandler = _props.commentClickHandler;
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'ViewBox-comments' },
	        _react2.default.createElement(
	          'ul',
	          null,
	          commentList ? commentList.map(function (comment) {
	            return _react2.default.createElement(
	              'li',
	              { className: 'u-margin-bottom--12', key: commentList.indexOf(comment), onClick: function onClick() {
	                  return commentClickHandler(comment);
	                } },
	              _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                  'a',
	                  null,
	                  (0, _Helper2.default)(comment.time)
	                ),
	                ' - ',
	                comment.content
	              )
	        ...
	        _react2.default.createElement('div', { className: 'ViewBox-listFilter' })
	      );
	    }
	  }]);
	  return CommentList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _youtubePlayer = __webpack_require__(396);
	...
	var VideoPlayer = function (_React$Component) {
	    ...
	    _this.onPlayerStateChange = function (event) {
	      if (event.target.getPlayerState() === 1) {
	        _this.interval = setInterval(function () {
	          _this.currentTime = event.target.getCurrentTime();
	          _this.updateComment();
	        }, 100);
	  ...
	  (0, _createClass3.default)(VideoPlayer, [{
	    ...
	    value: function createPlayer() {
	      this.internalPlayer = (0, _youtubePlayer2.default)(this.props.container, {
	        videoId: this.props.videoId
	      });
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'ViewBox-video u-margin-bottom--6' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadYouTubeIframeApi = __webpack_require__(399);
	
	var _loadYouTubeIframeApi2 = _interopRequireDefault(_loadYouTubeIframeApi);
	
	var _YouTubePlayer = __webpack_require__(401);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadScript = __webpack_require__(400);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _functionNames = __webpack_require__(402);
	
	var _functionNames2 = _interopRequireDefault(_functionNames);
	
	var _eventNames = __webpack_require__(403);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBar = function (_React$Component) {
	  (0, _inherits3.default)(CommentBar, _React$Component);
	
	  function CommentBar(props) {
	    (0, _classCallCheck3.default)(this, CommentBar);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (CommentBar.__proto__ || (0, _getPrototypeOf2.default)(CommentBar)).call(this, props));
	
	    _this.render = function () {
	      var _this$props = _this.props,
	          currentComment = _this$props.currentComment,
	          currentTime = _this$props.currentTime;
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'ViewBox-group' },
	        _react2.default.createElement(
	          'span',
	          null,
	          (0, _Helper2.default)(currentTime)
	        ),
	        ' -',
	        _react2.default.createElement(
	          'div',
	          { className: 'ViewBox-group-comment' },
	          _react2.default.createElement('textarea', { onKeyPress: _this._onEnter, placeholder: 'Enter Comment', className: 'ViewBox-input', ref: 'commentContent' }),
	          _react2.default.createElement(
	            'button',
	            { onClick: _this._onClick, className: 'ViewBox-input-submit' },
	            'Submit'
	          )
	        )
	      );
	  ...
	  (0, _createClass3.default)(CommentBar, [{
	    key: '_onEnter',
	    value: function _onEnter(event) {
	      if (event.charCode === 13) {
	        ...
	        this.props.postComment(commentToBePost, function (err, comment) {
	          if (err) {
	            console.log(err);
	          }
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SuggestVideo = function (_React$Component) {
	  (0, _inherits3.default)(SuggestVideo, _React$Component);
	
	  function SuggestVideo() {
	    (0, _classCallCheck3.default)(this, SuggestVideo);
	    return (0, _possibleConstructorReturn3.default)(this, (SuggestVideo.__proto__ || (0, _getPrototypeOf2.default)(SuggestVideo)).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(SuggestVideo, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	          videoList = _props.videoList,
	          videoClickHandler = _props.videoClickHandler;
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'Grid' },
	        videoList ? videoList.map(function (video) {
	          return _react2.default.createElement(
	            'div',
	            { className: 'Grid-item', key: videoList.indexOf(video), onClick: function onClick() {
	                return videoClickHandler(video);
	              } },
	            _react2.default.createElement('img', { src: video.thumbnail, width: '250', height: '180' })
	          );
	        }) : ' '
	      );
	    }
	...
	exports.default = SuggestVideo;

/***/ }

});
//# sourceMappingURL=1.1.b565e0e446556eaaf735.js.map